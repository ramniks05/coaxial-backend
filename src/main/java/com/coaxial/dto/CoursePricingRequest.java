...
public class CoursePricingRequest {
    ...
    // Constructors
    public CoursePricingRequest() {}
    
    public CoursePricingRequest(Long courseId, String courseName, BigDecimal monthlyPrice, 
    ...
    public Boolean getCascadeToClasses() {
        return cascadeToClasses;
    }
    
    public void setCascadeToClasses(Boolean cascadeToClasses) {
        this.cascadeToClasses = cascadeToClasses;
    }
